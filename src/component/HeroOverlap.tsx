        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center md:text-left text-white">
            ...
            <p className="max-w-xl text-sm md:text-base text-white/90 mb-6">
              A dramatic layered composition with two overlapping images flowing
              from the edges, a bold yellow accent palette, and high-contrast
              black and white typography. Replace the images or tweak the
              dimensions to match your layout.
            </p>
