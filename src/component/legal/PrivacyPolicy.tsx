  ...
  return (
    ...
    >
      ...
      <p className="mb-4 text-sm text-[#555555] text-justify">
        ...
        stores, and protects your personal information when you use Swaad Setu,
        our QR-based restaurant ordering and management platform. This Policy
        applies to restaurant owners, their staff, and customers who access our
      ...
      <ul className="mb-5 space-y-2 text-sm text-[#555555]">
        ...
        <li>
          Billing and settlement information (bank details, billing address)
        </li>
        <li>
          Menu items, categories, pricing, taxes, and availability details
        </li>
        <li>
      ...
      <h3
        id="cookies"
        className="mt-6 mb-4 flex items-center text-lg font-bold text-[#0F0F0F]"
      >
        <span className="mr-2 text-2xl leading-none text-[#FFBE00]">•</span>
      ...
      <p className="mb-4 text-sm text-[#555555] text-justify">
        ...
        changes will be communicated via the Platform or email, and the
        &quot;Last Updated&quot; date will be revised. Continued use of the
        Swaad Setu Platform after such changes constitutes acceptance of the
        updated Policy.
      </p>
      ...
      <p className="text-sm text-[#555555]">
        ...
        <br />
        Email:{" "}
        <a href="mailto:contact@zager.in" className="text-[#FFBE00] underline">
          contact@zager.in
        </a>{" "}
        | Support:{" "}
        <a
