  ...
  return (
    ...
    >
      ...
      <p className="mb-5 text-sm text-[#555555] text-justify">
        ...
        use of Swaad Setu, provided by Zager Digital Services (&quot;we&quot;,
        &quot;us&quot;, or &quot;our&quot;). By creating an account or using any
        part of the Swaad Setu Platform, you agree to be bound by these Terms.
      ...
      <ul className="mb-5 space-y-2 text-sm text-[#555555]">
        <li>
          <strong>&quot;Platform&quot;</strong> means the Swaad Setu website,
          web applications, QR ordering interfaces, and related services.
        </li>
        <li>
          <strong>
            &quot;Restaurant Partner&quot; or &quot;Restaurant&quot;
          </strong>{" "}
          means a food business entity that registers to use Swaad Setu.
        </li>
        <li>
          <strong>&quot;Customer&quot;</strong> means an end-user who places an
          order through a Swaad Setu QR or interface.
        </li>
        <li>
          <strong>&quot;Services&quot;</strong> means features provided via the
          Platform, including QR ordering, menu display, order management,
          payment integration, and basic analytics.
        </li>
        <li>
          <strong>&quot;Content&quot;</strong> means all text, images, software,
          graphics, and materials made available by Swaad Setu.
        </li>
        <li>
          <strong>
            &quot;Your Content&quot; or &quot;Restaurant Content&quot;
          </strong>{" "}
          means menus, images, branding, text, pricing, and any information you
          upload or configure.
        </li>
      </ul>
      ...
      <p className="mb-2 text-sm text-[#555555]">
        To become a Restaurant Partner, you confirm that:
      </p>
      <ul className="mb-5 space-y-2 text-sm text-[#555555]">
        <li>
      ...
      <ul className="mb-5 space-y-2 text-sm text-[#555555]">
        <li>
          Display accurate menu items, pricing, and availability on Swaad Setu.
        </li>
        <li>Update menu and prices promptly when changes occur.</li>
        <li>Prepare and serve food in a timely and safe manner.</li>
        <li>
          Handle customer complaints related to food, service, and in-restaurant
          experience.
        </li>
      </ul>
      ...
      <p className="mb-5 text-sm text-[#555555] text-justify">
        You agree to indemnify and hold harmless Zager Digital Services from any
        claims, damages, losses, and expenses (including legal fees) arising
      ...
      <p className="mb-5 text-sm text-[#555555] text-justify">
        ...
        the &quot;Last Updated&quot; date and may provide additional notice for
        material changes. Continued use of the Platform after changes become
