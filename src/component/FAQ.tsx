    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <>
            <p className="mt-4 mb-2 text-sm text-[#666666] leading-relaxed">
              <strong>Get started instantly!</strong> Just sign up and pay to
              access your account immediately with zero waiting time.
            </p>
          </>
        ),
      },
...

  {
    ...
    items: [
        ...
        answer: (
          <>
            ...
            <ul className="ml-5 mb-3 list-disc text-sm text-[#666666]">
              ...
              <li>
                <strong>Banking:</strong> UPI, Net Banking
              </li>
            </ul>
          </>
        ),
      ...
      },
      {
        id: "customer-4",
        question:
          "Can multiple customers at the same table order independently?",
        answer: (
          <>
            <p className="mt-4 mb-2 text-sm text-[#666666] leading-relaxed">
        ...
        answer: (
          <>
            <p className="mt-4 mb-1 text-sm text-[#666666] leading-relaxed">
              <strong>Menu Management:</strong> Easy-to-update digital menu with
              real-time availability
            </p>
            <p className="mb-1 text-sm text-[#666666] leading-relaxed">
              <strong>Order Management:</strong> Real-time tracking with Kitchen
              Display System integration
            </p>
            <p className="mb-1 text-sm text-[#666666] leading-relaxed">
              <strong>Analytics:</strong> Revenue reports, popular items, peak
              hours analysis
            </p>
            <p className="mb-1 text-sm text-[#666666] leading-relaxed">
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            <p className="mb-1 text-sm text-[#666666] leading-relaxed">
              <strong>Recommended:</strong> 5+ Mbps for smooth performance with
              multiple users
            </p>
            <p className="text-sm text-[#666666] leading-relaxed">
              System works on slower connections, though responsiveness may be
              slightly reduced.
            </p>
          </>
        ),
      },
      {
        ...
        answer: (
          <>
            <p className="mt-4 mb-2 text-sm text-[#666666] leading-relaxed">
              <strong>Yes!</strong> We integrate with most popular POS systems
              through:
            </p>
            <ul className="ml-5 mb-3 list-disc text-sm text-[#666666]">
    ...
    items: [
      {
        ...
        answer: (
          <>
            ...
            <ul className="ml-5 mb-3 list-disc text-sm text-[#666666]">
              <li>
                <strong>Basic Plan:</strong> For small restaurants with 1-2
                locations
              </li>
              <li>
                <strong>Professional Plan:</strong> For growing restaurants with
                advanced features
              </li>
              <li>
                <strong>Enterprise Plan:</strong> For multi-location chains with
                custom requirements
              </li>
            </ul>
          </>
      ...
      },
      {
        ...
        answer: (
          <>
            <p className="mt-4 mb-3 text-sm text-[#666666] leading-relaxed">
              <strong>No!</strong> Transaction fees only apply to digital
              payments. Cash orders have no additional fees beyond your annual
              subscription.
            </p>
          </>
        ),
    ...
    items: [
      {
        ...
        answer: (
          <>
            ...
            <ul className="ml-5 mb-3 list-disc text-sm text-[#666666]">
              <li>
                <strong>24/7 Email Support</strong> - Get answers to your
                questions
              </li>
              <li>
