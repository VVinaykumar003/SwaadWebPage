    ...
    admin: {
      ...
      slides: [
        ...
        },
        {
          ...
          caption:
            "Manage staff accounts, permissions, and store configuration.",
        },
      ],
    },
    staff: {
      ...
      slides: [
        {
          ...
          caption:
            "Scan QR, browse menu, customize items, place orders contactlessly.",
        },
        {
            ...
            {activeTab === "staff" && (
              <>
                <li className="flex gap-3 items-start">
                  <span className="w-2.5 h-2.5 mt-2 rounded-full bg-amber-500" />
                  <span className="text-gray-700">
                    Kitchen display with timers & prioritization
                  </span>
                </li>
                <li className="flex gap-3 items-start">
                  <span className="w-2.5 h-2.5 mt-2 rounded-full bg-amber-500" />
                  <span className="text-gray-700">
                    Fast POS workflows for quick checkout
                  </span>
                </li>
              </>
            )}
            ...
            {activeTab === "user" && (
              <>
                <li className="flex gap-3 items-start">
                  <span className="w-2.5 h-2.5 mt-2 rounded-full bg-amber-500" />
                  <span className="text-gray-700">
                    QR-driven contactless ordering
                  </span>
                </li>
                <li className="flex gap-3 items-start">
                  <span className="w-2.5 h-2.5 mt-2 rounded-full bg-amber-500" />
                  <span className="text-gray-700">
                    Order tracking & secure payments (UPI)
                  </span>
                </li>
              </>
            )}
