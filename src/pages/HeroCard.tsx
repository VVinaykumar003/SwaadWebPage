      ...
      <div className="max-w-6xl mx-auto text-center text-black relative z-10">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-8 bg-gradient-to-r from-black via-gray-800 to-black-900 bg-clip-text text-transparent leading-tight">
            Modern Office
            <span className="block text-yellow-900 text-4xl md:text-6xl">
              Management System
            </span>
          </h1>

          <p className="text-xl md:text-2xl text-black/80 mb-12 max-w-2xl mx-auto leading-relaxed">
            Real-time notifications, task tracking, and role-based access
            control built for modern teams.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20">
            ...
            <button
              ...
              className="px-12 py-6 border-4 border-black text-black text-lg font-bold rounded-full hover:bg-black hover:text-yellow-400 transition-all duration-300"
            >
              Watch Demo
            </button>
          </div>
