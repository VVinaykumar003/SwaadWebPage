...
const FAQ: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Swaad Setu FAQ – Everything About Our QR Ordering Platform
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Swaad Setu FAQ – Everything About Our QR Ordering Platform"
        />
        <meta
        ...
        <main className="max-w-6xl mx-auto px-5 mb-16 py-30">
          <div className="mb-10  w-full flex flex-col justify-center items-center">
            <h1 className="font-bold text-2xl lg:text-4xl ">
              SWAAD SETU - <span className="text-yellow-400">FAQ </span>
            </h1>
            <p className="text-gray-500 ">
              Everything you need to know about our QR-based ordering platform
            </p>
          </div>
