    ...
    <div className="min-h-screen bg-black">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.pexels.com/photos/1640772/pexels-photo-1640772.jpeg?auto=compress&cs=tinysrgb&w=1600)",
          }}
        >
        ...
        <div className="relative z-10 text-center px-4 animate-fadeIn">
          ...
          <p
            className="text-2xl md:text-4xl text-white mb-4 animate-slideUp"
            style={{ animationDelay: "0.2s" }}
          >
            Where Every Bite Feels Like Home
          </p>
          <p
            className="text-lg md:text-xl text-gray-300 mb-12 animate-slideUp"
      ...
      <section className="py-20 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg">
            Taste the favorites loved by thousands
          </p>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">
              Save more with our curated meal combos
            </p>
          </div>
      ...
      <section className="relative py-32 px-4 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.pexels.com/photos/1268558/pexels-photo-1268558.jpeg?auto=compress&cs=tinysrgb&w=1600)",
          }}
        >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Ready to Experience{" "}
            <span className="text-yellow-400">Authentic Flavours</span>?
          </h2>
          <p className="text-xl text-gray-300 mb-10">
            Join thousands of happy customers who trust Swaadsetu for their
            daily meals
          </p>
          <button
