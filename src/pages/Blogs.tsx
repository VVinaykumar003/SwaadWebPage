  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Swaad Setu Blog – Insights for Modern Restaurant Teams"
        />
        <meta
        ...
        <section className="border-b border-gray-200 bg-white mt-1">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-4">
              Insights for modern{" "}
              <span className="text-yellow-400">restaurant teams</span>
            </h1>

            <p className="text-gray-700 max-w-2xl mb-6">
              Product updates, practical guides, and stories from restaurants
              using technology to grow faster and serve better.
            </p>
